...
import { snapshotBrowserPage } from "../../runtime/electron/browser-command-agent.mjs";

const fixtureUrl = new URL("./fixtures/browser-observation-v2.json", import.meta.url);
const sourceUrl = new URL("../../runtime/electron/browser-command-agent.mjs", import.meta.url);
